...
\begin{frame}{Revisão de Números  Complexos\footnotemark}
\footnotetext[1]{Veja o apêndice do livro James Stewart, Cálculo Volume 1.}

\begin{itemize}
\item O conjunto dos \dt{números complexos}, denotado por  $\mathbb{C}$, são formados pelos elementos da forma
...
\item O \dt{Complexo Conjugado} de $z$ é $\bar{z}=a-bi$.


\item O  \dt{módulo} de $z$ é definido por $|z|:=\sqrt{a^2+b^2}$ e vale $z\bar{z}=|z|^2$.
