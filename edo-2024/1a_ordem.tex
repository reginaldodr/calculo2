...
\uncover<1->{Ao se trabalhar com equções diferenciais duas perguntas são naturais: Um problema de valor inicial 
\[\begin{cases}
y'(t)=f(t,y)\\
y(t_0)=y_0
\end{cases}\]
...
y(0)=1
\end{cases}\]
é {\color{blue}$y=\dps\frac{1}{t+1}$} definida no intervalo {\color{red}$(1,\infty)$}. Note que não existe uma solução definida em toda a reta!
